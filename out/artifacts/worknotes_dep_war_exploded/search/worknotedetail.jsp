...
<%@ page import="com.source11.worknotes.domain.Worknote,
...
<table width="700" border="1" align="center" cellpadding="0" cellspacing="1" >
  ...
  <tr>
    ...
    <td colspan="3"><textarea name="todayaim" cols="80" rows="6" readonly><c:out value="${worknote.helping}"/></textarea>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="130" bgcolor="#7ba2e7"><div align="center"> 评语：</div></td>
    <td colspan="3"><textarea name="todayaim" cols="80" rows="4" readonly><c:out value="${worknote.comment}"/></textarea>
    </td>
  </tr>
</table>
<br>
