...
<div align="center">
  ...
  <form name="changepw" action="/accountctl?command=ChangePwdBk" method="post" onSubmit="return pwdCheck();">
  ...
  <p>
    ...
    <input type="button" name="comeback" value="返回" onClick="javascript:location.href='/back/leftback.jsp'" >
  </p>
</form>
</div>
<hr>
